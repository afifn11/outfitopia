...
const LoginPage = () => {
    ...
    // Redirect kalau sudah authenticated
    useEffect(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Login dulu, navigate akan dipicu oleh useEffect isAuthenticated
        ...
        // Tidak set isLoading false di sini — navigate akan unmount komponen ini
    };
        ...
        <div className="min-h-screen bg-[#fafafa] flex items-center justify-center px-4 py-12 page-enter">
            <div className="w-full max-w-sm">
                ...
                <button onClick={handleGoogleLogin}
                    className="w-full flex items-center justify-center gap-3 border border-[#e8e8e8] py-3 mb-6 text-[12px] text-[#444] hover:bg-[#f4f4f4] transition-colors">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <input type="email" value={email} onChange={e => setEmail(e.target.value)} required
                            className="input-minimal" placeholder="your@email.com" autoComplete="email" />
                    </div>
                    <div>
                        <label className="block label-sm text-[#6b6b6b] mb-2">Password</label>
                        <div className="relative">
                            <input type={showPassword ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} required
                                className="input-minimal pr-10" placeholder="••••••••" autoComplete="current-password" />
