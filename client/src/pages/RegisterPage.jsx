...
const RegisterPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (password.length < 8) {
            MySwal.fire({ title: 'Password terlalu pendek', text: 'Minimal 8 karakter.', icon: 'warning', confirmButtonColor: '#0a0a0a' });
            return;
        }
        setIsLoading(true);
        try {
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input type={showPassword ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} required minLength={8}
                                className="input-minimal pr-10" placeholder="Min. 8 characters" />
